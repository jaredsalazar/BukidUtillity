...
public class CamActivity extends ActionBarActivity implements SurfaceHolder.Callback {
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, final int width, final int height) {
        ...
        camera.setPreviewCallback(new Camera.PreviewCallback() {
            ...
            public void onPreviewFrame(byte[] data, final Camera camera) {
                ...
                TextView statView = (TextView) findViewById(R.id.tvCamStat);
                ...
                //new pixelSorter(rgb,frameWidth,frameHeight);
                ...
                final TextView result = (TextView) findViewById(R.id.tvCamResult);
                surfaceview.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        boolean getColor = pref.getBoolean("GetColor", false);
                        if (getColor == true) {
                            JSONObject jcolor = new JSONObject();
                            JSONArray ajColor = new JSONArray();

                            try {
                                jcolor.put("red", red);
                                jcolor.put("green", green);
                                jcolor.put("blue", blue);
                                ajColor.put(jcolor);
                            } catch (JSONException e) {
                                e.printStackTrace();
                            }

                            String color = String.valueOf(ajColor);

                            editor = pref.edit();
                            editor.putString("color", color);
                            editor.putBoolean("GetColor", false);
                            editor.apply();
